...
{
    //Sen Genericrepositoryden miras al kim için Product sınıfı için ve IProductDal için
    public class EfProductDal : GenericRepository<Product>, IProductDal
    {
        public List<Object> GetProductsWithCategory()
        {
            ...
            return values.Cast<object>().ToList();
                //aslında yukarıdakilerde amacımız burdaki sınıftan(product) qldeki tabloya(products) atama yapmak
