...
namespace CSharpEgitimKampi301.EFProject
{
    public partial class FrmStatistics : Form
    {
        ...
        private void FrmStatistics_Load(object sender, EventArgs e)
        {
            ...
            //Hoca virgülden sonra iki basamak gözüksün istedi alt satır bunun çözümü
            ...
            /*Burayı hocadan önce kendim denedim ama hocanın var mantığı daha sağlıklı
             çünkü dönüşümle uğraşmıyorsun
            int guideId = int.Parse(db.Location.Where(x=>x.City== "Roma Turistik").Select(y=>y.GuideId).FirstOrDefault().ToString());
